...
export function CandidateDetail() {
  ...
  const stages = [
    { id: '1', name: 'Applied', description: 'Initial application received' },
    { id: '2', name: 'Screening', description: 'Phone/video screening' },
    { id: '3', name: 'Interview', description: 'Technical/behavioral interview' },
    { id: '4', name: 'Offer', description: 'Job offer extended' },
    { id: '5', name: 'Hired', description: 'Successfully hired' }
  ];
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-secondary-600">Candidate Profile</p>
        </div>
